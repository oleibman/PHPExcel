...
class PHPExcel_Writer_Excel2007_Worksheet extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeSheetPr(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // sheetPr
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeDimension(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // dimension
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeSheetViews(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // sheetViews
...
//      }
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeSheetFormatPr(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // sheetFormatPr
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeCols(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // cols
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeSheetProtection(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // sheetProtection
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeConditionalFormatting(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // Conditional id
        $id = 1;
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeDataValidations(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeHyperlinks(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeProtectedRanges(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeMergeCells(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writePrintOptions(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // printOptions
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writePageMargins(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // pageMargins
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeAutoFilter(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        $autoFilterRange = $pSheet->getAutoFilter()->getRange();
        if (!empty($autoFilterRange)) {
            // autoFilter
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writePageSetup(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // pageSetup
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeHeaderFooter(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
        // headerFooter
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeBreaks(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeSheetData(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet, $pStringTable = null)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeCell(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet, $pCellAddress = null, $pStringTable = null, $pFlippedStringTable = null)
    {
...
//                                $calculatedValue = $pCell->getCalculatedValue();
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeDrawings(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet, $includeCharts = false)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeLegacyDrawing(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeLegacyDrawingHF(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet)
    {
