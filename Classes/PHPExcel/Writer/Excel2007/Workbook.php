...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeWorkbook(PHPExcel $pPHPExcel, $recalcRequired = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeFileVersion(PHPExcel_Shared_XMLWriter $objWriter)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeWorkbookPr(PHPExcel_Shared_XMLWriter $objWriter)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeBookViews(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel $pPHPExcel)
    {
        // bookViews
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeWorkbookProtection(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel $pPHPExcel)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeCalcPr(PHPExcel_Shared_XMLWriter $objWriter, $recalcRequired = true)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeSheets(PHPExcel_Shared_XMLWriter $objWriter, ?PHPExcel $pPHPExcel = null)
    {
        // Write sheets
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeSheet(PHPExcel_Shared_XMLWriter $objWriter, $pSheetname = '', $pSheetId = 1, $pRelId = 1, $sheetState = 'visible')
    {
        if ($pSheetname != '') {
            // Write sheet
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeDefinedNames(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel $pPHPExcel)
    {
        // Write defined names
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeDefinedNameForAutofilter(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet, $pSheetId = 0)
    {
        // definedName for autoFilter
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeDefinedNameForPrintTitles(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet, $pSheetId = 0)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeDefinedNameForPrintArea(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $pSheet, $pSheetId = 0)
    {
