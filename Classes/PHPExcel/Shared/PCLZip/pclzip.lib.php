...
class PclZip
{
    ...
    // --------------------------------------------------------------------------------
    public function __construct($p_zipname) // Owen was PclZip
    {
    ...
    public function privOptionDefaultThreshold(&$p_options)
    {
        ...
        if ($last == 'g') {
            ...
            $v_memory_limit = ((int) substr($v_memory_limit, 0, -1)) * 1073741824; // Owen
        }
        if ($last == 'm') {
            //$v_memory_limit = $v_memory_limit*1024*1024;
            $v_memory_limit = ((int) substr($v_memory_limit, 0, -1)) * 1048576; // Owen
        }
        if ($last == 'k') {
            $v_memory_limit = ((int) substr($v_memory_limit, 0, -1)) * 1024; // Owen
        }
