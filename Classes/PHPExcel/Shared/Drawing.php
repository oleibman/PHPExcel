...
class PHPExcel_Shared_Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pValue, PHPExcel_Style_Font $pDefaultFont) // Owen 20200917 remove default
    {
        // Font name and size
     ...
     * @return     int        Value in pixels
     */
    public static function cellDimensionToPixels($pValue, PHPExcel_Style_Font $pDefaultFont) // Owen 20200917 remove default
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();
